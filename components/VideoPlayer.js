...
export default function VideoPlayer() {
  return (
    <>
      ...
      <div className="font-mono bg-black text-white" id="videoplayer">
      ...
      <a href="#audioplayer" className="text-center">
        <h1 className="text-3xl font-bold font-mono">Go to Audio Player</h1>
